#> collecting_turtle_eggs:game_area/test/tide_level_change/high_to_midle
#
# -15
#
# @within
...
tag @e[tag=high] add midle
tag @e[tag=high] remove high

schedule function collecting_turtle_eggs:game_area/test/tide_level_change/high_to_midle 7t