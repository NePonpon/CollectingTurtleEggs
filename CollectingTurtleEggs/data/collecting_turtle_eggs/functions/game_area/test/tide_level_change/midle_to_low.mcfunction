#> collecting_turtle_eggs:game_area/test/tide_level_change/midle_to_low
#
# -15
#
# @within
...
tag @e[tag=midle] add low
tag @e[tag=midle] remove midle

schedule function collecting_turtle_eggs:game_area/test/tide_level_change/midle_to_low 7t