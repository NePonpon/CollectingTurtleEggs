#> collecting_turtle_eggs:game_area/test/tide_level_change/low_to_midle
#
# +15
#
# @within
...
tag @e[tag=low] add midle
tag @e[tag=low] remove low

schedule function collecting_turtle_eggs:game_area/test/tide_level_change/low_to_midle 7t